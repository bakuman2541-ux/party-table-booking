...
// ✅ วางทับได้ทั้งไฟล์
// ✅ FIX: กดแก้ไขแล้วไม่ขึ้นข้อมูล/Modal เพี้ยน
// =============================
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // =====================================================
  // ✅ FIX: Modal เปิด/ปิดด้วย class เท่านั้น (ไม่ใช้ style.display)
  // =====================================================
  function openModal() {
    if (!editModal) return;
    ...
    // ให้ modal render ก่อน แล้วค่อย focus (ทำให้ค่าที่ set โชว์ชัวร์)
    setTimeout(() => {
